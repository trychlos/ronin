/*
 * priority_values_model.js
 * To be imported at application layer level.
 *
 * Messages:
 *  - ronin.model.priority.delete
 */
...
$.pubsub.subscribe( 'ronin.model.priority_value.delete', ( msg, o ) => {
    try {
    ...
    bootbox.confirm(
        'You are about to delete the "'+o.name+'" priority value.<br />'+
        'Are you sure ?', function( ret ){
            if( ret ){
                Meteor.call( 'priority_values.remove', o, ( e, res ) => {
                    if( e ){
                        messageError({ type:e.error, message:e.reason });
                    } else {
                        messageSuccess( 'Priority value successfully deleted' );
...
// insert or update the provided priority_value
...
$.pubsub.subscribe( 'ronin.model.priority_value.update', ( msg, o ) => {
    //console.log( msg );
    //console.log( o );
    o.edit._id = o.orig ? o.orig._id : null;
    o.edit.userId = o.orig ? o.orig.userId : null;
    try {
        PriorityValues.fn.check( o.edit );
    ...
    if( o.orig ){
        ...
        if( PriorityValues.fn.equal( o.orig, o.edit )){
            messageWarning( 'Nothing changed' );
            return false;
        }
        Meteor.call( 'priority_values.update', o.edit, ( e, res ) => {
            if( e ){
                console.log( e );
                messageError({ type:e.error, message:e.reason });
                if( o.cb ){
                ...
                messageSuccess( 'Priority value successfully updated' );
                if( o.cb ){
        ...
        Meteor.call( 'priority_values.insert', o.edit, ( e, res ) => {
            if( e ){
                console.log( e );
                messageError({ type:e.error, message:e.reason });
                if( o.cb ){
                ...
                messageSuccess( 'Priority value successfully inserted' );
                if( o.cb ){

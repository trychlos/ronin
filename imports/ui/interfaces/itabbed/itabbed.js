...
( function( $ ){
    $.fn.iTabbed = function(){
        ...
        const idx = $.fn.iTabbed.index( element, Session.get('setup.tab.name'));
        element.jqxTabs({ selectedItem: idx });

        // events tracker
        element.on( 'selected', function( event ){
            var selectedTab = event.args.item;
            const tabs = $.fn.iTabbed.tabs( element );
    ...
    $.fn.iTabbed.index = function( element, name ){
        const tabs = $.fn.iTabbed.tabs( element );
    ...
    $.fn.iTabbed.tabs = function( element ){
